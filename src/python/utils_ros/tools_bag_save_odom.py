...
parser.add_argument('--out_odom_path', type=str, help='/tmp/odom.txt')
parser.add_argument('--topic_odom', type=str, help='/current_odom')
...
def save_odom_tum_format(args):
	...
	bag.close()
	np.savetxt(args.out_odom_path, np.array(odom_list), '%.9f')
